 ...
 * This file demonstrates how to integrate Limiterurn with a web frontend
 */

// For React/Vue/Angular applications
export class LimiterurnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new LimiterurnClient(provider, contractAddress);
